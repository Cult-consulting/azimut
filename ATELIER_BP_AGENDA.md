# Atelier Business Plan - Agenda

**Date** : 4 février 2026 - 15h00-16h00
...
Beaucoup de travail préparatoire a été fait en amont (nom validé "Cresceo", structure de gouvernance définie, plan de lancement créé). Cet atelier se concentre sur les **décisions clés** restantes et la **répartition des actions**.

Un atelier de follow-up/validation sera programmé si nécessaire.
...
|-------|-------------------|
| Igor majoritaire | Quel % exact ? |
| Baptiste + Julien bloc de contrôle | Quel % chacun ? |
| JP + Raph passifs | Quel % chacun ? |
| Éloïse part mineure | Quel % ? |
| Capital social | 10k€ confirmé ? |

**Livrable** : Tableau de répartition définitif
...
|--------|-------------|----------|
| Achat domaines cresceo.fr / .com | ? | Semaine 1 |
| Dépôt marque INPI | ? | Semaine 1 |
| Rédaction statuts SAS | ? | Semaine 2 |
| Finalisation pacte associés | ? | Semaine 2 |
| Contact expert-comptable | ? | Semaine 2 |
| Création juridique | ? | Mars |

**Livrable** : Tableau d'actions avec responsables et dates
...
- [ ] Transition vers atelier MKG/Com (16h00)
...
*Enchaîne directement sur l'atelier MKG/Com à 16h00*
