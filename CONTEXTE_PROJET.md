...
## Pacte d'Associés - Draft Préparé

**Statut** : Draft prêt pour validation en atelier BP

### Clauses principales couvertes
- Gouvernance (seuils, majorités, réunions)
- Engagement des associés (temps, activités parallèles)
- Non-concurrence (périmètre, durée, exceptions)
- Cession de parts (agrément, préemption, tag-along, drag-along)
- Valorisation (good/bad leaver, multiple EBITDA)
- Propriété intellectuelle
- Gestion des conflits d'intérêts (CAD 42, Spiraliss/Vinci)
- Résolution des litiges

### Points à valider en atelier
- [ ] Seuil palier 1 - Président seul (1k€ ? 2k€ ? 3k€ ?)
- [ ] Seuil palier 2 - Président + DG (5k€ ? 10k€ ? 15k€ ?)
- [ ] Engagement temps par associé (h/sem ou j/mois selon profil)
- [ ] Durée lock-up (2 ou 3 ans)
- [ ] Multiple EBITDA (4x ? 5x ? 6x ?)
- [ ] Décote bad leaver (30% ? 50% ?)

→ Détail complet : [PACTE_ASSOCIES_DRAFT.md](PACTE_ASSOCIES_DRAFT.md)
